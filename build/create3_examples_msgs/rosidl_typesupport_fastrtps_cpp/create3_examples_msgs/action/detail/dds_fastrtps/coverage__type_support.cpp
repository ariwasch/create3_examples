...
{
  return max_serialized_size_Coverage_Goal(full_bounded, 0);
}
...
{
  return max_serialized_size_Coverage_Result(full_bounded, 0);
}
...
{
  return max_serialized_size_Coverage_Feedback(full_bounded, 0);
}
...
{
bool cdr_serialize(
  const create3_examples_msgs::action::Coverage_Goal &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
  return max_serialized_size_Coverage_SendGoal_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_Coverage_SendGoal_Response(full_bounded, 0);
}
...
{
  return max_serialized_size_Coverage_GetResult_Request(full_bounded, 0);
}
...
{
bool cdr_serialize(
  const create3_examples_msgs::action::Coverage_Result &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
  return max_serialized_size_Coverage_GetResult_Response(full_bounded, 0);
}
...
{
bool cdr_serialize(
  const create3_examples_msgs::action::Coverage_Feedback &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
  return max_serialized_size_Coverage_FeedbackMessage(full_bounded, 0);
}
